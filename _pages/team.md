...
<p class="section-index">PEOPLE · 구성원</p>
<h1>People behind HuBot Lab.</h1>
<p>We bring together perception, learning, planning, and control to build robots that understand, learn from, and work with humans.<span class="bilingual-ko" lang="ko">인지, 학습, 계획, 제어를 통합해 사람을 이해하고 배우며 협력하는 로봇을 만듭니다.</span></p>
</div>

<section class="people-section">
<p class="section-index">PRINCIPAL INVESTIGATOR · 연구책임자</p>
