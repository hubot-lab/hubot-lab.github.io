...
<section>
  ...
  <p>Please introduce yourself, describe the research questions that excite you, and include a CV or brief summary of your experience.</p>
  <a href="mailto:{{ site.email }}" class="text-link">Email Prof. Jung <span aria-hidden="true">→</span></a>
</section>
</div>

<div class="join-note"><strong>Lab location:</strong> {{ site.address }}<br><a href="mailto:{{ site.email }}">{{ site.email }}</a></div>
</div>
